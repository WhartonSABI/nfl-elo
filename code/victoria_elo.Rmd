...
ggplot(elo_averages_rusher, aes(x = as.numeric(interaction_n), y = elo_avg, color = player_name)) +
  geom_line(size = 1.2, alpha = 0.8) +
  geom_point(size = 1, shape = 21, fill = "white", stroke = 0.6) +
  scale_color_viridis_d(option = "mako", begin = 0.1, end = 0.9,
                        name = "Player") +
...
ggplot(elo_averages_blocker, aes(x = as.numeric(interaction_n), y = elo_avg, color = player_name)) +
  geom_line(size = 1.2, alpha = 0.8) +
  geom_point(size = 1, shape = 21, fill = "white", stroke = 0.6) +
  scale_color_viridis_d(option = "mako", begin = 0.1, end = 0.9,
                        name = "Player") +
