...
games_data <- read_csv("../data/raw/games.csv") #game by game information
players_data <- read_csv("../data/raw/players.csv") #player level information
plays_data <- read_csv("../data/raw/plays.csv") #play by play information
game_id <- read_csv("../data/raw/tracking_gameId_2017090700.csv") #tracking data for each play
...
```{r}
tracking <- read.csv("../data/raw/tracking_week_1.csv")
plays <- read.csv("../data/raw/plays.csv")
players <- read.csv("../data/raw/players.csv")
