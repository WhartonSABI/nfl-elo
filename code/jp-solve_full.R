# this script runs the elo rating system on the full dataset
...
write_csv(elo_history, "../data/results/full_elo_history.csv")
write_csv(elo_labeled, "../data/results/full_player_elo_ratings.csv")
# save plots
ggsave("../data/results/full_top_10_rushers.png", plot = top_10_rushers, width = 8, height = 6)
ggsave("../data/results/full_top_10_blockers.png", plot = top_10_blockers, width = 8, height = 6)
